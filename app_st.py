...
st.markdown(
    """
    <h1 style='text-align: center; color: #2E86AB;'> EmiraBankBot: Simplifying Banking in the Emirates</h1>
    <p style='text-align: center; font-size:18px;'>Get reliable answers on UAE banking, regulations, accounts, loans, and more.</p>
...
st.markdown(
    ...
    <div style='font-size: 14px; color: gray; margin-top: 20px;'>
        <strong>Disclaimer:</strong> EmirBankBot is an AI-powered assistant designed to provide general information about banking services and regulations in the United Arab Emirates. 
        While we strive to keep the information accurate and up-to-date, it should not be considered as official financial, legal, or investment advice. 
        For specific queries or up-to-date policies, please contact your bank or consult the UAE Central Bank's official website.
    </div>
    """, 
    unsafe_allow_html=True
)
...
if st.session_state.show_history and st.session_state.prompt_history:
    if st.sidebar.button("📥 Export History"):
        ...
        st.sidebar.download_button(
            ...
            data=history_json,
            file_name=f"Banking_chatbot_history_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json",
